                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(_cityName,style: TextStyle(fontSize: 20,fontWeight: FontWeight.w500)),
                    ],
                  ),
                  SizedBox(height: 50,),
                  Text("$_temperature C",style: TextStyle(color: Colors.black38,fontSize: 90,fontWeight: FontWeight.bold),),
                  Row(
                    children: [
                      Text(_main,style: TextStyle(fontSize: 22,fontWeight: FontWeight.w500),),
                  ...
                  Row(
                    children: [
                      ...
                      Text("$_tempMax °C",style: TextStyle(fontSize: 22,fontStyle: FontStyle.italic,),),
                      const Icon(Icons.arrow_downward),
                      Text("$_tempMin °C",style: TextStyle(fontSize: 22,fontStyle: FontStyle.italic,),),
                    ],
                  ),
                  SizedBox(height: 25,),
                  Card(
